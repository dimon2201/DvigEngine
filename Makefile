...
CXX					:= g++
CXX_SOURCE    		= $(CXX) $(CXXFLAGS) -c $(1) -o $(2) -Ithirdparty/XAudio2/include &&
CXX_OBJECT    		= $(CXX) $(CXXFLAGS) -o main.exe $(1) lib/DvigEngine_v00_01.a thirdparty/glfw_win64/lib-mingw-w64/libglfw3.a -lgdi32 -lopengl32
...
pre-compile :
	...
	@rmdir build
	@mkdir build
	cd lib/ && echo This file is not a library. This file is used for Makefile to work correctly. Leave it in the libs folder. > _not_a_library && cd ../

compile :
# $(call COMPILE,$(SOURCES_DIR))
# Compile and link libraries
	$(call CLEAR_FOLDER, lib/)
	$(call COMPILE, source/)
	$(call MAKE_LIB, lib/DvigEngine_v00_01.a, source/)
