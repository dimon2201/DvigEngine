...
CXX_OBJECT    		= $(CXX) $(CXXFLAGS) -o main.exe $(1) libs/DvigEngine_v00_01.a thirdparty/glfw_win64/lib-mingw-w64/libglfw3dll.a
...
# Compile and link libraries
	...
	$(call COMPILE, source/)
	$(call MAKE_LIB, libs/DvigEngine_v00_01.a, source/)
