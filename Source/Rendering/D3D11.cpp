...
ID3D11ShaderResourceView* DvigEngine::D3D11::CreateShaderResourceView(ID3D11Buffer* buffer, const usize byteWidth, const usize elementByteWidth)
{
    ...
    srvDesc.Buffer.ElementWidth = elementByteWidth;
    srvDesc.Buffer.ElementOffset = 0;
    srvDesc.Buffer.NumElements = byteWidth / elementByteWidth;
