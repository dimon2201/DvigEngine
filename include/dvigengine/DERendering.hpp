...
namespace DvigEngine
{
    ...
    class ShaderComponent : public IComponent
    {
        ...
        public:
            void Init(const char* shaderPathOnDrive);
            void Free() override final;
    ...
    class RenderTargetGroup : public IHelper
    {
        public:
    ...
    class RenderPassInfo : public IInfo
    {
        public:
            RenderPassType Type;
    ...
    class RenderBatchInfo : public IInfo
    {
        public:
    ...
    class RenderBatchInstanceInfo : public IInfo
    {
        public:
            float Offset;
    };
