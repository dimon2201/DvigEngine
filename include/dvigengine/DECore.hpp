...
namespace DvigEngine
{
    ...
    class ICommon
    {
        ...
        private:
            DVIG_FUNCTION_INLINE void SetUSIDAndMemoryObject(const char* usid, MemoryObject* memObject) {
    ...
    class IComponent : public ICommon
    {
        public:
            virtual void Free() {}
    };
    ...
    class IHelper : public ICommon
    {
        public:
            virtual void Free() {}
    };

    class Collection : public IHelper
    {
        public:
    ...
    class HashedCollection : public IHelper
    {
        public:
    ...
    class INode : public ICommon
    {
        public:
            ...
            void InsertChildInstance(ICommon* instance);
            ICommon* FindChildInstance(const char* label);

            template <typename T>
            T* FindChildInstanceByType()
            {
                for (uint32 i = 0; i < this->m_Childs->GetCount(); ++i) {
                    ICommon* instance = (*((ICommon**)this->m_Childs->FindAt(i)));
            ...
            void RemoveChildInstance(const char* label);

        private:
            Collection* m_Childs;
    };

    class MemoryPoolInfo : public IInfo
    {
        public:
            void* m_Address;
            usize m_ByteWidth;
    ...
    class Engine
    {
        public:
            ...
            T* Create(const char* usid)
            {
                ...
                T instanceOnStack;
                if (dynamic_cast<IComponent*>(&instanceOnStack) != nullptr) {
                    memoryPoolIndex = 1;
                }
                ...
                instance->SetUSIDAndMemoryObject( (const char*)&usid[0], memObject );
            ...
            DVIG_FUNCTION_INLINE void Delete(ICommon* instance)
            {
